...
*/
// Values obtained from Touchscreen_Calibr_native.ino
// download, run, then copy values from terminal window
const int XP=9,XM=A3,YP=A2,YM=8; //320x480 ID=0x9488
const int TS_LEFT=127,TS_RT=910,TS_TOP=63,TS_BOT=951;
